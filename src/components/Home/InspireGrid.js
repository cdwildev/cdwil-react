...
{/*     <svg style={{position: 'absolute', top: '-100px', left: '-100px', zIndex: '-100', width: '20vw'}}width="333" height="136" viewBox="0 0 333 136" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg style={{position: 'absolute', bottom: '-100px', right: '-100px',  width: '20vw'}} width="827" height="127" viewBox="0 0 827 127" fill="none" xmlns="http://www.w3.org/2000/svg">
