...
export const SkillSelect = ({ handleInnerClick, handleMiddleClick, bachelor, setBachelor, major, setMajor, skill, setSkill, skillList }) => {
  ...
  return (
    ...
    <BoldUI style={{display: bachelor ? 'flex' : 'none' }}>Major</BoldUI> 
      ...
      <SelectionContainerUI style={{display: bachelor == 'media-arts' ? 'flex' : 'none' }}>
        ...
        <SelectionUI id="fmsa" onClick={() => setMajor('fmsa')} style={{background: major == 'fmsa' ? 'white' : 'transparent', color : major == 'fmsa' ? '#005695' : 'white' }}>NMSA</SelectionUI>
